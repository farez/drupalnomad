 ...
 */
function gavias_mion_form_system_theme_settings_alter(&$form, &$form_state) {
  $form['#attached']['library'][] = 'gavias_mion/gavias-mion-admin';  
  ...
  $form['header']['list_page_layout_boxed'] = array(
    '#type'   => 'textarea',
  ...
  $form['header']['default_header'] = array(
    ...
    '#options' => array(
      ...
      'header-2' => t('header-2: Background gray'),
      'header-3' => t('Header-3: Absolute'),
    ),
  );
