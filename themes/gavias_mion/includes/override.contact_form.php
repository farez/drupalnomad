<?php
function gavias_mion_form_contact_message_feedback_form_alter(&$form, \Drupal\Core\Form\FormStateInterface $form_state, $form_id) {
  
  // Name
  $form['name']['#weight'] = -1;
  $form['name']['#prefix'] = '<div class="contact-feedback"><div class="row"><div class="col-sm-4 col-xs-12"><div class="form-group">';
  ...
  // Mail
  $form['mail']['#weight'] = -2;
  $form['mail']['#prefix'] = '<div class="col-sm-4 col-xs-12"><div class="form-group">';
  ...
  $form['subject']['widget'][0]['#prefix'] = '<div class="col-sm-4 col-xs-12"><div class="form-group">';
